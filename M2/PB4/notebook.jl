...
# ╔═╡ 1deb7c20-c664-4ddb-b3cf-13789e5a6e4c
using Distributions, LinearAlgebra, Plots

# ╔═╡ ebea649e-c136-11f0-313a-73a374c3e49b
md"
# Problem Set 4 - Exercise 2 
"

# ╔═╡ 5f9a0a8c-a82f-415d-855e-7a77177b3e97
md"
### Henrik Berger - Romain Fernex
"

# ╔═╡ b137b99c-48e2-4c05-b37f-3924c26aeb55
md"
#### Block 0 - Initialization
"

# ╔═╡ 31af268f-57af-4116-bf2b-8d9ec3117235
begin 
	##Define Parameters
	struct par_model
	...
	function tauchen(mean, sd, rho, num_states; q=3) # creates state transition matrix
...
# ╔═╡ 2c66347b-6d4d-441e-9e1e-c4dfdb5f0a17
md"
#### Block 1 : Utility Grid and Value Iteration Function
"

# ╔═╡ 5f47d1d9-b192-4970-a7a2-695083921539
begin
...
# ╔═╡ 80444145-63ae-46b4-8e85-c24bdc08f213
md"
#### Block 2 : Aigari and Stable Distribution Functions
"

# ╔═╡ 853a2f58-34aa-49c8-b520-a1ad29384425
begin
...
# ╔═╡ 6ff829e1-833e-44df-9a96-bc73c9f66d88
md"
#### Block 3 : Aggregate Demand and Supply
"

# ╔═╡ 43f79151-4f55-4e31-865d-6e34182db945
begin
...
# ╔═╡ 8e21088a-5482-411a-a7db-9a1bcba34134
begin
	Plots.plot(agg_a,r_vec[:])
	Plots.plot!(agg_D,r_vec[:])
end

# ╔═╡ a552aaf0-c88b-4a8c-808d-294bcb69a1e2
md"
#### Bisection to recover the equilibrium IR, Value Function and Policy Function
"

# ╔═╡ 1af7bfc2-61a3-482e-a94a-f9eb73de8691
begin 
	r_up = 1/par.beta-1
	r_low = -par.delta
	Vguess_eq = copy(Vguess)
	while r_up-r_low > par.tol
	    global r_eq = 0.5*r_up + 0.5*r_low
	    global S, Vguess_eq = aiyagari(r_eq, par, agrid, sgrid,prob, Vguess_eq)
	    global D = ((par.alpha)/(r_eq+par.delta))^(1/(1-par.alpha))
	    if S-D > 0
	        global r_up = r_eq
	    else 
	        global r_low = r_eq
...
# ╔═╡ 61b30daa-eb36-4f77-af90-9f5953a0e809
md"
Equilibrium Value Function 
"

# ╔═╡ 86f2cf9e-67b2-41a4-bc38-549dd86d3d53
plot(agrid, Vguess_eq[:,:]')

# ╔═╡ bf401f64-d549-4f2a-9f92-987a32805c3a
md"
Stable Distribution
"

# ╔═╡ c008de56-1b4b-4973-ba1c-1a2c468eb28d
plot(agrid, dist[:,:]')

# ╔═╡ bfcc1b97-b600-4300-8ec1-286cc180b09f
md"
Equilibrium Policy Function
"

# ╔═╡ 7aa12851-6a82-4793-81e3-a8251f84f716
plot(agrid, a_idx[:,:]')

# ╔═╡ 7d7221cc-af21-43d6-a2d4-53ca7b18d399
md"
Equilibrium Values
"

# ╔═╡ 6d9c5e0f-a624-4c27-af07-3fd7ab5f9b02
begin
	println("The equilibrium interest rate is : $r_eq")
...
manifest_format = "2.0"
project_hash = "36be50a3a0b84266200b65f127ab7925058baf5e"
