...
# ╔═╡ 9ff9b022-6292-4d53-9ad6-31f2d4a1d08c
begin
	using Distributions, LinearAlgebra, Plots
end

# ╔═╡ 62a2c170-a608-11f0-220b-ddedafb9afdd
md""" 
# Problem Set 3 - Exercise 2
"""

# ╔═╡ f10605a4-3fd2-4b8a-8647-3ccda89db516
md"""
### Henrik Berger & Romain Fernex
"""

# ╔═╡ 68d849c7-1cc7-4c02-acf6-1faa4204f4af
begin
	##Define Parameters
...
# ╔═╡ 70276fab-a375-4e43-9258-6aa291dbb976
begin
...
# ╔═╡ f0cab979-7d32-40d8-a34d-742ed387a3fd
md"""
1. Build the 3D utility array.
"""

# ╔═╡ 3bb85bed-550e-4583-9296-6da5d84d7bcf
begin
...
# ╔═╡ f33c57cd-6066-4301-853d-625c108abb2c
display(round.(U,digits = 3))

# ╔═╡ 3b961f6a-bf63-493f-8079-fcc50048fbb7
md"""
2. Given the guess of the value function, compute the expected value function.
"""

# ╔═╡ d27767a4-b372-4bed-a54f-e2c2e988e921
begin
...
# ╔═╡ 36ecde99-c91f-483b-a431-f2d42e86505b
md"""
3. Find the policy functions using Value function iteration.
"""

# ╔═╡ d4ff32e5-5535-4e16-b2ed-fc739b8e6fda
begin
...
# ╔═╡ 245deb0d-d0e1-4cbf-b809-60301874824b
begin 
...
# ╔═╡ 8a7f503d-3893-432e-82f3-ada6e9181852
begin
	println("Value function :")
	display(round.(Vnew,digits = 3))
	println("Policy function for assets : ")
	display(round.(policy_a,digits = 3))
	println("Policy function for consumption : ")
	display(round.(policy_c,digits = 3))
end

# ╔═╡ cb23096a-470a-4bc4-9aea-6e31a4cad7fe
md"""
4. Plot the results.
"""

# ╔═╡ 8dbf9d42-8697-48ae-895f-bd723c828a8a
Plots.plot(agrid,Vnew[:,:]')

# ╔═╡ 02d32193-8609-4f4b-9fb3-44248e16af59
Plots.plot(agrid,policy_c[:,:]')

# ╔═╡ 13e828b0-08c3-42ab-ba35-3c098c9d270d
